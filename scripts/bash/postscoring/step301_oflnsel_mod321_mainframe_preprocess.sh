...
#Functions
#parentdir=/mapr/pchmaprclt01.prod.pch.com/CM/HDLP/Common/DEV/Scripts/oflnsel/scripts/bash/postscoring/
...
sh "$PROJ_BASH_CORE_DIR"/oflnsel_prezip_hdp_transfer.sh mod321

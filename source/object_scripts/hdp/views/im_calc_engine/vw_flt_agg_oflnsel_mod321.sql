DROP VIEW IF EXISTS ${hivevar:DEP_ENV}_im_calc_engine.vw_flt_agg_oflnsel_mod321;

CREATE VIEW IF NOT EXISTS ${hivevar:DEP_ENV}_im_calc_engine.vw_flt_agg_oflnsel_mod321 COMMENT 'oflnsel' AS SELECT  agg_oflnsel_mod321.abe12 , 
...
agg_oflnsel_mod321.vars601  FROM ${hivevar:DEP_ENV}_IM_CALC_ENGINE.agg_oflnsel_mod321

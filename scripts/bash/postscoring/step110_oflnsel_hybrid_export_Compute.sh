...
function main() {
    ...
    if ! gen_jar_execution ${CALCENGINE_JAR_VER_NAME} ${LIBJARS} ${JAR_ENV} ${HYBRID_EXPORT_JAR_FG} ${JAR_RESOURCES} ${PWD_FILE_RES}; then

        post_process_validations ${HYBRID_EXPORT_JAR_FG}
